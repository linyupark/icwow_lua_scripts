...
-- icwow
Config_Gold[10] = 20000
Config_Gold[20] = 60000
Config_Gold[30] = 100000
Config_Gold[40] = 200000
Config_Gold[50] = 300000
Config_Gold[61] = 500000
Config_Gold[65] = 600000
Config_Gold[71] = 700000
Config_Gold[75] = 800000
Config_Gold[80] = 1000000
...
local Config_mailSubject2 = "铛铛铛～升级奖励到了!"
local Config_mailText2A = " 年轻的冒险家你的出色成功引起了我的关注～你是全服第"
local Config_mailText2B = " 位到达"
local Config_mailText2C = " 等级的哟～希望你能再接再厉，勇往直前～～"
...
local function OnLogin(event, player)
    if (event) then
        player:SendBroadcastMessage("ICWOW模块 |cff4CFF00升级奖励|r 已运行.")
    end
end
